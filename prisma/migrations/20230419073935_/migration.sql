...
-- AddForeignKey
ALTER TABLE "PostTagJoin" ADD CONSTRAINT "PostTagJoin_postId_fkey" FOREIGN KEY ("postId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PostTagJoin" ADD CONSTRAINT "PostTagJoin_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES "Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
